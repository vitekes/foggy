    ...
    i.fn.dataTable = function (g) {
        function l() {
            ...
            this.oLanguage = {
                ...
                sLengthMenu: "Показать _MENU_ на странице",
                sZeroRecords: "Ничего не найдено",
                sEmptyTable: "No data available in table",
                sLoadingRecords: "Loading...",
                sInfo: "Показано с _START_ по _END_ из _TOTAL_ объектов",
                sInfoEmpty: "объекты не найдены",
                sInfoFiltered: "(всего _MAX_ объектов)",
                sInfoPostFix: "",
                sSearch: "Search:",
                sUrl: "",
                oPaginate: {
        ...
        function za(a) {
            if (a.bAjaxDataGet) {
                ...
                if (a.oFeatures.bSort !== false) {
                    var f = a.aaSortingFixed !== null ? a.aaSortingFixed.length : 0,
                        e = a.aaSorting.length;
                    c.push({
                        name: "iSortingCols",
                        value: f + e
                    });
        ...
        function Aa(a, b) {
            ...
            var c = ha(a);
            if (c = typeof b.sColumns != "undefined" && c !== "" && b.sColumns != c) var d = Ba(a, b.sColumns);
        ...
        function Ia(a) {
            ...
            if (i(a.nTable).outerWidth() < f) if (a.oScroll.sX === "") J(a, 1, "The table cannot fit into the current element which will cause column misalignment. It is suggested that you enable x-scrolling or increase the width the table has in which to be drawn");
        ...
        function J(a, b, c) {
            ...
            if (b === 0) if (o.sErrMode == "alert") alert(a);
            else throw a;
        ...
        this.fnGetData = function (a, b) {
            ...
            if (typeof a != "undefined") {
                ...
                if (typeof b != "undefined") return H(c, a, b, "");
        ...
        this.oApi._fnFeatureHtmlFilter =
        Da;
        ...
        return this.each(function () {
            ...
            if (this.nodeName.toLowerCase() != "table") J(e, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);
                ...
                if (c) {
                    e.asDestoryStrips = ["", ""];
                    if (i(d[0]).hasClass(e.oClasses.sStripOdd)) e.asDestoryStrips[0] += e.oClasses.sStripOdd + " ";
